...
public class Parser {
    ...
    /**
     * Статический метод, преобразующий строку вида 'Стобец' отношение значение в промежуточный объект Block
     * для последующей обработки данных (создания новой записи таблицы или изменение существующих).
